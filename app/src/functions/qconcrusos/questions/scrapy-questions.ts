...
export async function scrapyQuestions(page: Page): Promise<any> {
  return page.evaluate((QUESTIONS_LIST_SELECTOR: string) => {
    ...
    questionsElement.forEach((e: any) => {
      //question headers
      const urlElement = e.querySelector("div.q-question-header > div.q-ref > div > a");
      const idElement = e.querySelector("div.q-question-header > div.q-ref > div > a");
      const subjectUrlElement = e.querySelector( "div.q-question-header > div.q-question-breadcrumb > a");
      const subjectNameElement = e.querySelector("div.q-question-header > div.q-question-breadcrumb > a");
      ...
      e.querySelectorAll("div.js-question.q-question > div.q-question-info > span")
      .forEach((el: any) => {
     ...
     const enunciationElement = e.querySelector("div.js-question.q-question > div.q-question-body > div.q-question-enunciation");
     const enunciationImageElement = e.querySelector("div.js-question.q-question > div.q-question-body > div.q-question-enunciation > img");
     body.enunciation.description = enunciationElement !== null ? enunciationElement.innerText.replace("\n", " ") : "";
     body.enunciation.image = enunciationImageElement !== null ? enunciationImageElement.src : "";
     ...
     for (let index = 0; index < alternativeIds.length; index++) {
      ...
      result.push({
        ...
        questionId: idElement !== null ? idElement.text.split("Q")[1].trim() : null,
        subjectURL: subjectUrlElement !== null ? subjectUrlElement.href : "",
        subjectName: subjectNameElement !== null ? subjectNameElement.text.split("\n")[1].trim().toLowerCase() : "",
        ...info,
        ...body
      })
    });
